  ...
  describe "GET /" do
    ...
    scenario "booking a flight" do
      ...
      within(:css, "div#passengers") do
        fill_in "booking_passengers_attributes_0_name", with: "navneet"
        fill_in(
          "booking_passengers_attributes_0_email",
          with: "navneet@gmail.com"
        )
      ...
      within(:css, "div#passengers") do
        ...
        expect(page).to have_content("navneet")
        expect(page).to have_content("navneet@gmail.com")
